...
use gamboamartin\inmuebles\html\inm_rel_referencia_comprador_html;
...
class controlador_inm_rel_referencia_comprador extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new inm_rel_referencia_comprador(link: $link);
        $html_ = new inm_rel_referencia_comprador_html(html: $html);
    ...
    public function modifica(bool $header, bool $ws = false): array|stdClass
    {
        ...
        $keys_selects = $this->key_select(cols:6, con_registros: true,filtro:  array(), key: 'inm_comprador_id',
            keys_selects: array(), id_selected: $this->registro['inm_comprador_id'],
            label: 'comprador');
        if(errores::$error){
            return $this->retorno_error(mensaje: 'Error al maquetar key_selects',data:  $keys_selects, header: $header,ws:  $ws);
        }
    ...
    {
        $columns["inm_referencia_comprador_id"]["titulo"] = "Id";
        ...
        $filtro = array("inm_referencia_comprador.id","inm_comprador.descripcion",
