...
use gamboamartin\inmuebles\html\inm_rel_doc_cheque_html;
...
class controlador_inm_rel_doc_cheque extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new inm_rel_doc_cheque(link: $link);
        $html_ = new inm_rel_doc_cheque_html(html: $html);
    ...
    {
        $columns["inm_rel_doc_cheque_id"]["titulo"] = "Id";
        $columns["inm_rel_doc_cheque_descripcion"]["titulo"] = "Descripcion";

        $filtro = array("inm_rel_doc_cheque.id","inm_rel_doc_cheque.descripcion");
