...
use gamboamartin\inmuebles\html\inm_almacen_html;
...
class controlador_inm_almacen extends _ctl_formato {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new inm_almacen(link: $link);
        $html_ = new inm_almacen_html(html: $html);
    ...
    {
        $columns["inm_almacen_id"]["titulo"] = "Id";
        $columns["inm_almacen_descripcion"]["titulo"] = "Descripcion";

        $filtro = array("inm_almacen.id","inm_almacen.descripcion");
