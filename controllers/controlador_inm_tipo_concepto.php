...
use gamboamartin\inmuebles\html\inm_tipo_concepto_html;
...
class controlador_inm_tipo_concepto extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new inm_tipo_concepto(link: $link);
        $html_ = new inm_tipo_concepto_html(html: $html);
    ...
    {
        $columns["inm_tipo_concepto_id"]["titulo"] = "Id";
        $columns["inm_tipo_concepto_descripcion"]["titulo"] = "Descripcion";

        $filtro = array("inm_tipo_concepto.id","inm_tipo_concepto.descripcion");
