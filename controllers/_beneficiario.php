...
class _beneficiario{
    ...
    final public function inputs_beneficiario(controlador_inm_prospecto $controler){
        ...
        $nombre = $controler->html->input_text(cols: 2, disabled: false, name: 'beneficiario[nombre]',
        ...
        $apellido_paterno = $controler->html->input_text(cols: 2, disabled: false,
        ...
        $apellido_materno = $controler->html->input_text(cols: 2, disabled: false,
        ...
        $inm_parentesco_id = $controler->html->select_catalogo(cols: 3, con_registros: true,
        ...
        $inm_tipo_beneficiario_id = $controler->html->select_catalogo(cols: 3, con_registros: true,
            id_selected: $row_upd->inm_parentesco_id, modelo: $modelo,
