...
class controlador_inm_status_prospecto extends _ctl_formato {

    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new inm_status_prospecto(link: $link);
        $html_ = new inm_status_prospecto_html(html: $html);
    ...
    {
        $columns["inm_status_prospecto_id"]["titulo"] = "Id";
        $columns["inm_status_prospecto_descripcion"]["titulo"] = "Descripcion";

        $filtro = array("inm_status_prospecto.id","inm_status_prospecto.descripcion");
