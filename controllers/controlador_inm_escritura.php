...
use gamboamartin\inmuebles\html\inm_escritura_html;
...
class controlador_inm_escritura extends _ctl_formato {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new inm_escritura(link: $link);
        $html_ = new inm_escritura_html(html: $html);
    ...
    {
        $columns["inm_escritura_id"]["titulo"] = "Id";
        $columns["inm_escritura_descripcion"]["titulo"] = "Descripcion";

        $filtro = array("inm_escritura.id","inm_escritura.descripcion");
