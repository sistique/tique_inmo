...
use gamboamartin\inmuebles\html\inm_firma_html;
...
class controlador_inm_firma extends _ctl_formato {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new inm_firma(link: $link);
        $html_ = new inm_firma_html(html: $html);
    ...
    {
        $columns["inm_firma_id"]["titulo"] = "Id";
        $columns["inm_firma_descripcion"]["titulo"] = "Descripcion";

        $filtro = array("inm_firma.id","inm_firma.descripcion");
