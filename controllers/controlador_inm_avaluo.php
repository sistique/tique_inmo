...
use gamboamartin\inmuebles\html\inm_avaluo_html;
...
class controlador_inm_avaluo extends _ctl_formato {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new inm_avaluo(link: $link);
        $html_ = new inm_avaluo_html(html: $html);
    ...
    {
        $columns["inm_avaluo_id"]["titulo"] = "Id";
        $columns["inm_avaluo_descripcion"]["titulo"] = "Descripcion";

        $filtro = array("inm_avaluo.id","inm_avaluo.descripcion");
