...
use gamboamartin\inmuebles\html\inm_rel_transferencia_ubicacion_html;
...
class controlador_inm_rel_transferencia_ubicacion extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new inm_rel_transferencia_ubicacion(link: $link);
        $html_ = new inm_rel_transferencia_ubicacion_html(html: $html);
    ...
    {
        $columns["inm_rel_transferencia_ubicacion_id"]["titulo"] = "Id";
        $columns["inm_rel_transferencia_ubicacion_descripcion"]["titulo"] = "Descripcion";

        $filtro = array("inm_rel_transferencia_ubicacion.id","inm_rel_transferencia_ubicacion.descripcion");
