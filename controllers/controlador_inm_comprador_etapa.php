...
use gamboamartin\inmuebles\html\inm_comprador_etapa_html;
...
class controlador_inm_comprador_etapa extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new inm_comprador_etapa(link: $link);
        $html_ = new inm_comprador_etapa_html(html: $html);
    ...
    public function modifica(bool $header, bool $ws = false): array|stdClass
    {
        ...
        $columns_ds = array('inm_comprador_id','inm_comprador_nss','inm_comprador_curp','inm_comprador_nombre',
            'inm_comprador_apellido_paterno','inm_comprador_apellido_materno');
        $keys_selects = $this->key_select(cols:6, con_registros: true,filtro:  array(), key: 'inm_comprador_id',
            keys_selects: $keys_selects, id_selected: $registro->inm_comprador_id, label: 'Ubicacion', columns_ds : $columns_ds);
        if(errores::$error){
            return $this->retorno_error(mensaje: 'Error al maquetar key_selects',data:  $keys_selects,
                header: $header,ws:  $ws);
        }

        $fecha = $this->html->input_fecha(cols: 12,row_upd: new stdClass(),value_vacio: false,value: $registro->inm_comprador_etapa_fecha);
        if(errores::$error){
            return $this->retorno_error(
                mensaje: 'Error al obtener inputs',data:  $fecha, header: $header,ws:  $ws);
        }
    ...
    private function init_datatable(): stdClass
    {
        ...
        $columns["inm_comprador_etapa_fecha"]["titulo"] = "Colonia";


        $filtro = array("inm_comprador.id","pr_etapa.descripcion",'pr_proceso.descripcion','inm_comprador_etapa.fecha');
