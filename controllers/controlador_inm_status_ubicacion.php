...
class controlador_inm_status_ubicacion extends _ctl_formato {

    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new inm_status_ubicacion(link: $link);
        $html_ = new inm_status_ubicacion_html(html: $html);
    ...
    {
        $columns["inm_status_ubicacion_id"]["titulo"] = "Id";
        $columns["inm_status_ubicacion_descripcion"]["titulo"] = "Descripcion";

        $filtro = array("inm_status_ubicacion.id","inm_status_ubicacion.descripcion");
