...
use gamboamartin\inmuebles\html\inm_conf_institucion_campo_html;
...
class controlador_inm_conf_institucion_campo extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new inm_conf_institucion_campo(link: $link);
        $html_ = new inm_conf_institucion_campo_html(html: $html);
