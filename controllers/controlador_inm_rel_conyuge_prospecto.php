...
class controlador_inm_rel_conyuge_prospecto extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new inm_rel_conyuge_prospecto(link: $link);
        $html_ = new inm_rel_conyuge_prospecto_html(html: $html);
    ...
    public function modifica(bool $header, bool $ws = false): array|stdClass
    {
        ...
        $keys_selects = $this->key_select(cols:6, con_registros: true,filtro:  array(), key: 'inm_conyuge_id',
            keys_selects: $keys_selects, id_selected: $this->registro['inm_rel_conyuge_prospecto_id'],
            label: 'Prospecto');
        if(errores::$error){
            return $this->retorno_error(mensaje: 'Error al maquetar key_selects',data:  $keys_selects, header: $header,ws:  $ws);
        }
    ...
    {
        $columns["inm_rel_conyuge_prospecto_id"]["titulo"] = "Id";
        $columns["inm_prospecto_descripcion"]["titulo"] = "Prospecto";
        $columns["inm_conyuge_descripcion"]["titulo"] = "Conyuge";

        $filtro = array("inm_rel_conyuge_prospecto_id.id","inm_prospecto.descripcion",
