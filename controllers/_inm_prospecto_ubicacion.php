...
class _inm_prospecto_ubicacion{
    ...
    private function identificadores_comercial(array $filtro): array
    {
        ...
        $identificadores['inm_prototipo_id']['cols'] = 3;
        ...
        $identificadores['inm_tipo_credito_id']['cols'] = 3;
        ...
        $identificadores['inm_complemento_id']['cols'] = 3;
        ...
        $identificadores['inm_estado_vivienda_id']['cols'] = 3;
        ...
        $identificadores['inm_tipo_vivienda_id']['cols'] = 3;
