...
class inm_prospecto_proceso_html extends html_controler {

    public function select_inm_prospecto_proceso_id(int $cols, bool $con_registros, int $id_selected, PDO $link,
