...
class inm_rel_costo_cheque_html extends html_controler {

    public function select_inm_rel_costo_cheque_id(int $cols, bool $con_registros, int $id_selected, PDO $link,
