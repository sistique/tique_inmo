...
class inm_beneficiario_html extends html_controler {

    public function select_inm_beneficiario_id(int $cols, bool $con_registros, int $id_selected, PDO $link,
                                                        ...
                                                        array $filtro = array()): array|string
    {
        ...
        $select = $this->select_catalogo(cols: $cols, con_registros: $con_registros, id_selected: $id_selected,
            ...
            label: 'Beneficiario', required: true);
        if (errores::$error) {
