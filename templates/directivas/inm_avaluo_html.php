...
class inm_avaluo_html extends html_controler {

    public function select_inm_avaluo_id(int $cols, bool $con_registros, int $id_selected, PDO $link,
                                      bool $disabled = false, array $filtro = array()): array|string
    {
        $modelo = new inm_avaluo(link: $link);
