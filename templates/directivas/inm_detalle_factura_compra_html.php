...
class inm_detalle_factura_compra_html extends html_controler {

    public function select_inm_detalle_factura_compra_id(int $cols, bool $con_registros, int $id_selected, PDO $link,
