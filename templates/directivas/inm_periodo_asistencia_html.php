...
class inm_periodo_asistencia_html extends html_controler {

    public function select_inm_periodo_asistencia_id(int $cols, bool $con_registros, int $id_selected, PDO $link,
