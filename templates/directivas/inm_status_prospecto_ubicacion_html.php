...
class inm_status_prospecto_ubicacion_html extends html_controler {

    public function select_inm_status_prospecto_ubicacion_id(int $cols, bool $con_registros, int $id_selected, PDO $link,
                                                   array $columns_ds = array(), bool $disabled = false,
                                                   array $filtro = array(), string $label = 'Status Prospecto'): array|string
    {
        $modelo = new inm_status_prospecto_ubicacion(link: $link);
