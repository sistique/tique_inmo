...
class inm_conf_docs_ubicacion_html extends html_controler {

    public function select_inm_conf_docs_ubicacion_id(int $cols, bool $con_registros, int $id_selected, PDO $link,
