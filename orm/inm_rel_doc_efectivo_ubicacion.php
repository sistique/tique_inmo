...
class inm_rel_doc_efectivo_ubicacion extends _modelo_parent{
    public function __construct(PDO $link)
    {
        $tabla = 'inm_rel_doc_efectivo_ubicacion';
        $columnas = array($tabla=>false, 'inm_efectivo' => $tabla, 'inm_doc_ubicacion' => $tabla,
        ...
        $this->etiqueta = 'Relacion Documento Efectivo';
    }
    ...
    private function descripcion(array $registro): string|array
    {
        ...
        $descripcion = $registro['inm_efectivo_id'];
    ...
    private function valida_alta_relacion(array $registro){
        ...
        $keys = array('inm_efectivo_id','inm_doc_ubicacion_id');
