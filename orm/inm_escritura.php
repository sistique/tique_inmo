...
class inm_escritura extends _modelo_parent{
    ...
    public function alta_bd(array $keys_integra_ds = array('codigo', 'descripcion')): array|\stdClass
    {
        ...
        if($resultado->n_registros > 0){
            ...
            $registro_mod['numero_escritura'] = $this->registro['numero_escritura'];
            $registro_mod['fecha_escritura'] = $this->registro['fecha_escritura'];
            $r_mod_esc = $this->modifica_bd(registro:$registro_mod,
                id: $resultado->registros[0]['inm_escritura_id']);
            if (errores::$error) {
                return $this->error->error(mensaje: 'Error al insertar datos', data: $r_mod_esc);
            }
