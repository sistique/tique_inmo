...
class inm_co_acreditado extends _modelo_parent{
    public function __construct(PDO $link)
    {
        ...
        $atributos_criticos = array('nss','curp','rfc', 'apellido_paterno','apellido_materno','nombre', 'lada',
            'numero','celular','genero', 'correo','nombre_empresa','nrp','lada_nep','numero_nep',
            'extension_nep');
    ...
    public function alta_bd(array $keys_integra_ds = array('codigo', 'descripcion')): array|stdClass
    {
        ...
        if(!isset($this->registro['razon_social'])){
            $partes = array_filter([ $this->registro['nombre'], $this->registro['apellido_paterno'],
                $this->registro['apellido_materno'] ]);

            $this->registro['razon_social'] = implode(" ", $partes);
        }
