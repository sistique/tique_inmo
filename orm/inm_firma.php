...
class inm_firma extends _modelo_parent{
    ...
    public function alta_bd(array $keys_integra_ds = array('codigo', 'descripcion')): array|\stdClass
    {
        ...
        if(!$existe) {
            if(isset($_FILES['notificacion_descuento_sec']) && trim($_FILES['notificacion_descuento_sec']['name']) !== '') {
        ...
        foreach ($documentos as $campo => $tipo_doc) {
            ...
            $filtro_doc['inm_comprador.id'] = $this->registro['inm_comprador_id'];
            $filtro_doc['doc_tipo_documento.id'] = $tipo_doc;
            ...
            if($existe_xml && isset($_FILES[$campo]) && !empty($_FILES[$campo]['name'])){
