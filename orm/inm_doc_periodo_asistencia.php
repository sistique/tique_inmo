...
class inm_doc_periodo_asistencia extends _modelo_parent{
    public function __construct(PDO $link)
    {
        $tabla = 'inm_doc_periodo_asistencia';
        $columnas = array($tabla=>false,'inm_periodo_asistencia'=>$tabla,'doc_documento'=>$tabla,
            'doc_tipo_documento'=>'doc_documento','doc_extension'=>'doc_documento');

        $campos_obligatorios = array('inm_periodo_asistencia_id','doc_documento_id');
        ...
        $atributos_criticos = array('inm_periodo_asistencia_id','doc_documento_id');
...
*/
    ...
    private function descripcion(stdClass $r_alta_doc, array $registro): string
    {
        ...
        $descripcion .= ' '.$registro['inm_periodo_asistencia_id'];
    ...
    final public function inm_docs_comprador(int $inm_periodo_asistencia_id, array $tipos_documentos)
    {
        $in = array();
        ...
        $r_inm_doc_prospecto = $this->filtro_and(filtro: array('inm_periodo_asistencia.id' => $inm_periodo_asistencia_id,
            'inm_doc_periodo_asistencia.es_foto' => 'inactivo'), in: $in);
        if (errores::$error) {
