...
class inm_conf_docs_prospecto_ubicacion extends _modelo_parent{
    public function __construct(PDO $link){
        $tabla = 'inm_conf_docs_prospecto_ubicacion';
        $columnas = array($tabla=>false,'doc_tipo_documento'=>$tabla,'pr_sub_proceso'=>$tabla,
            'pr_proceso'=>'pr_sub_proceso');

        $campos_obligatorios = array('doc_tipo_documento_id','es_obligatorio','pr_sub_proceso_id');

        $columnas_extra= array();

        $atributos_criticos = array('doc_tipo_documento_id','es_obligatorio','pr_sub_proceso_id');
        ...
        $this->etiqueta = 'Conf de tipos de documentos ubicacion';
    }
