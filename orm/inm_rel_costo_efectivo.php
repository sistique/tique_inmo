...
class inm_rel_costo_efectivo extends _modelo_parent{
    public function __construct(PDO $link)
    {
        $tabla = 'inm_rel_costo_efectivo';
        $columnas = array($tabla=>false,'inm_costo'=>$tabla, 'inm_efectivo'=>$tabla);
...
/*
        if($this->registro['inm_tipo_efectivo_id'] === 1){
            $registro = array();
        ...
        }else if($this->registro['inm_tipo_efectivo_id'] === 2){
            $registro = array();
            $registro['inm_ubicacion_id'] = $this->registro['inm_ubicacion_id'];
