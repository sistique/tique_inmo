...
class inm_prospecto extends _modelo_parent{
    public function __construct(PDO $link)
    {
        ...
        $columnas = array($tabla=>false,'com_prospecto'=>$tabla,'inm_producto_infonavit'=>$tabla,
            ...
            'inm_ocupacion'=>$tabla,'inm_status_prospecto'=>$tabla,'org_sucursal'=>$tabla, 'inm_tipo_venta'=>$tabla,
    ...
    private function data_com_prospecto(stdClass $registro): array
    {
        ...
        $data_com_prospecto['com_agente_id'] = $registro->com_agente_id;
    ...
    public function elimina_bd(int $id): array|stdClass
    {
        ...
        $del = (new inm_rel_referencia_prospecto(link: $this->link))->elimina_con_filtro_and(filtro:$filtro);
        if(errores::$error){
    ...
    final public function inm_co_acreditados(int $inm_prospecto_id): array
    {
        if($inm_prospecto_id <= 0){
                                ...
                                array $keys_integra_ds = array('codigo', 'descripcion')): array|stdClass
    {
        ...
        $inm_prospecto_anterior = $this->registro(registro_id: $id);
        if (errores::$error) {
        ...
        if(isset($registro['com_agente_cerrador_id']) &&
            ...
            $registro['com_agente_id'] = $registro['com_agente_cerrador_id'];
            $registro['com_prospecto_id'] = $inm_prospecto_anterior['com_prospecto_id'];
        ...
        $upd = $this->post_upd(id: $id, keys_integra_ds:  $keys_integra_ds, r_modifica:  $r_modifica,
            reactiva:  $reactiva);
        if(errores::$error){
    ...
    final public function transacciones_upd(int $inm_prospecto_id){
        ...
        $result_beneficiario = (new _upd_prospecto())->transacciona_beneficiario(inm_prospecto_id: $inm_prospecto_id,
            link: $this->link);
        if (errores::$error) {
