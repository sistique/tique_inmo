...
<div class="control-group col-sm-6">
    ...
    <div class="controls">
        <input type="time" name="hora_inicio" value="<?php echo $controlador->hora_inicio; ?>" class="form-control" required="" id="hora_inicio" placeholder="Hora Inicio">
    </div>
</div>
...
<div class="control-group col-sm-6">
    ...
    <div class="controls">
        <input type="time" name="hora_fin" value="<?php echo $controlador->hora_fin; ?>" class="form-control" required="" id="hora_fin" placeholder="Hora Fin">
    </div>
</div>
