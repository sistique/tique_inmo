...
let sl_cat_sat_tipo_contrato_nom = $("#cat_sat_tipo_contrato_nom_id");
...
sl_nom_empleado.change(function(){
    ...
    let cat_sat_tipo_contrato_nom_id  = selected.data('em_empleado_cat_sat_tipo_contrato_nom_id');
    ...
    sl_cat_sat_tipo_contrato_nom.val(cat_sat_tipo_contrato_nom_id).change();
});
