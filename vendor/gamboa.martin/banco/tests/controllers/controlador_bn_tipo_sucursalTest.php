...
class controlador_bn_tipo_sucursalTest extends test {
    ...
    public function test_key_selects_txt(): void
    {
        ...
        $controler = new controlador_bn_tipo_sucursal(link: $this->link,paths_conf: $this->paths_conf);
        ...
        $this->assertEquals('Tipo Sucursal',$resultado['descripcion']->place_holder);
