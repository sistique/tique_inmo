...
use base\orm\modelo;
use gamboamartin\banco\controllers\controlador_bn_detalle_layout;
...
class bn_detalle_layout_html extends html_controler {

    private function asigna_inputs_alta(controlador_bn_detalle_layout $controler, array|stdClass $inputs): array|stdClass
    {
    ...
    private function asigna_inputs_modifica(controlador_bn_detalle_layout $controler, stdClass $inputs): array|stdClass
    {
    ...
    public function genera_inputs_alta(controlador_bn_detalle_layout $controler, modelo $modelo, PDO $link, array $keys_selects = array()): array|stdClass
    {
    ...
    private function genera_inputs_modifica(controlador_bn_detalle_layout $controler,PDO $link,
    ...
    public function inputs_bn_detalle_layout(controlador_bn_detalle_layout $controlador,
                                      stdClass $params = new stdClass()): array|stdClass
    {
