...
class controlador_com_tipo_prospecto extends \gamboamartin\comercial\controllers\controlador_com_tipo_prospecto {
    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(), stdClass $paths_conf = new stdClass())
    {
        ...
        $this->childrens_data['com_tipo_prospecto']['title'] = 'Tipo Prospecto';
    }
}
