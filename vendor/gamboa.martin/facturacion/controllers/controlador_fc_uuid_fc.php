...
use gamboamartin\facturacion\html\fc_uuid_fc_html;
...
class controlador_fc_uuid_fc extends _ctl_parent_sin_codigo {
    ...
    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(), stdClass $paths_conf = new stdClass()){
        ...
        $datatables->filtro[] = 'fc_uuid_fc.id';
