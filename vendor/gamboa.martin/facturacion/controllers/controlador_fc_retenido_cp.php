...
use gamboamartin\facturacion\html\fc_retenido_cp_html;
...
class controlador_fc_retenido_cp extends _base_system_conf {

    public array|stdClass $keys_selects = array();

    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass()){
        $modelo = new fc_retenido_cp(link: $link);
        $html_ = new fc_retenido_cp_html(html: $html);
    ...
    {
        $columns["fc_retenido_cp_id"]["titulo"] = "Id";
        $columns["fc_retenido_cp_codigo"]["titulo"] = "Codigo";
        $columns["fc_partida_descripcion"]["titulo"] = "Partida";
        $columns["fc_retenido_cp_descripcion"]["titulo"] = "Descripción";
        ...
        $filtro = array("fc_retenido_cp.id","fc_retenido_cp.codigo","fc_retenido_cp.descripcion","fc_partida.descripcion",
