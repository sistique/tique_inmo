<?php /** @var  gamboamartin\facturacion\controllers\controlador_fc_traslado_dr_part $controlador  controlador en ejecucion */ ?>
...
<?php echo $controlador->inputs->fc_traslado_dr_id; ?>
