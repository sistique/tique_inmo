...
class fc_ejecucion_aut_plantilla_html extends html_controler {

    public function select_fc_ejecucion_aut_plantilla_id(int $cols, bool $con_registros, int $id_selected, PDO $link,
                                         ...
                                         array $registros = array()): array|string
    {
        ...
        $select = $this->select_catalogo(cols: $cols, con_registros: $con_registros, id_selected: $id_selected,
            modelo: $modelo, columns_ds: $columns_ds, disabled: $disabled, filtro: $filtro, label: 'Ejecuciones',
