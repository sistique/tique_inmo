...
class controlador_not_mensaje_etapa extends _ctl_parent_sin_codigo {

    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass()){
        $modelo = new not_mensaje_etapa(link: $link);
        $html_ = new not_mensaje_etapa_html(html: $html);
    ...
    final public function init_datatable(): stdClass
    {
        ...
        $columns["not_mensaje_etapa_id"]["titulo"] = "Id";
        $columns["not_mensaje_etapa_fecha"]["titulo"] = "Fecha";
        $columns["not_mensaje_id"]["titulo"] = "Rel Mensaje Id";
        $columns["pr_etapa_proceso_id"]["titulo"] = "Pr Etapa Proceso Id";

        $filtro[] = array("not_mensaje_etapa.id");
        $filtro[] = array("not_mensaje_etapa.fecha");
