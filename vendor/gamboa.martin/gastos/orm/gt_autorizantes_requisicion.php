...
class gt_autorizantes_requisicion extends _base_auto_soli
{
    public function __construct(PDO $link)
    {
        $tabla = 'gt_autorizantes_requisicion';
        $columnas = array($tabla => false, 'gt_requisicion' => $tabla, 'gt_autorizante' => $tabla,
            "em_empleado" => 'gt_autorizante', "gt_centro_costo" => 'gt_requisicion');
