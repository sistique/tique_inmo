...
use html\gt_orden_compra_etapa_html;
use html\gt_solicitud_producto_html;
use PDO;
use stdClass;

class controlador_gt_orden_compra_etapa extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_orden_compra_etapa(link: $link);
        $html_ = new gt_orden_compra_etapa_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Orden Compra Etapa';
        $this->titulo_lista = 'Registro de Orden Compra Etapa';
