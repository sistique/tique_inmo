...
class controlador_gt_tipo_centro_costo extends _ctl_parent_sin_codigo {
                                ...
                                stdClass $paths_conf = new stdClass())
    {
        ...
        $html_ = new gt_tipo_centro_costo_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Tipo Centro Costo';
        $this->titulo_lista = 'Registro de Tipo Centro Costo';
    ...
    {
        $columns["gt_tipo_centro_costo_id"]["titulo"] = "Id";
        $columns["gt_tipo_centro_costo_descripcion"]["titulo"] = "Descripción";

        $filtro = array("gt_tipo_centro_costo.id","gt_tipo_centro_costo.descripcion");
