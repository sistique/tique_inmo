...
class controlador_gt_autorizante extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_autorizante(link: $link);
        $html_ = new gt_autorizante_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Autorizante';
        $this->titulo_lista = 'Registro de Autorizante';
