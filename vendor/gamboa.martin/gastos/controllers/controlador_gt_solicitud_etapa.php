...
class controlador_gt_solicitud_etapa extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_solicitud_etapa(link: $link);
    ...
    {
        $this->seccion_titulo = 'Solicitud Etapa';
        $this->titulo_lista = 'Registro de Solicitud Etapa';
    ...
    protected function init_datatable(): stdClass
    {
        ...
        $filtro = array("gt_solicitud_etapa.id","gt_solicitud.descripcion","pr_proceso.descripcion",
