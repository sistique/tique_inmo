...
class controlador_gt_solicitud_producto extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_solicitud_producto(link: $link);
        $html_ = new gt_solicitud_producto_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Solicitud Producto';
        $this->titulo_lista = 'Registro de Solicitud Producto';
    ...
    protected function init_datatable(): stdClass
    {
        ...
        $filtro = array("gt_solicitud_producto.id","gt_solicitud.descripcion","com_producto.descripcion",
            "cat_sat_unidad.descripcion", "gt_solicitud_producto.cantidad");
