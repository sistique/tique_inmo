...
use html\gt_orden_compra_cotizacion_html;
...
class controlador_gt_orden_compra_cotizacion extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_orden_compra_cotizacion(link: $link);
        $html_ = new gt_orden_compra_cotizacion_html(html: $html);
    ...
    private function init_configuraciones(): controler
    {
        ...
        $this->titulo_lista = 'Registro de Ordenes de Compra - Cotizacion';
