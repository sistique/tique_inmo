...
class controlador_gt_autorizante_solicitantes extends _ctl_base {
    ...
    {
        $this->seccion_titulo = 'Autorizantes Solicitantes';
    ...
    {
        $columns["gt_autorizante_solicitantes_id"]["titulo"] = "Id";
        $columns["gt_autorizante_descripcion"]["titulo"] = "Autorizante";
        $columns["gt_solicitante_descripcion"]["titulo"] = "Solicitante";

        $filtro = array("gt_autorizante_soliciantes.id","gt_autorizante.descripcion",
