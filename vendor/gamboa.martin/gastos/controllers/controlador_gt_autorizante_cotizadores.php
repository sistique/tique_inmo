...
use html\gt_autorizante_cotizadores_html;
...
class controlador_gt_autorizante_cotizadores extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_autorizante_cotizadores(link: $link);
        $html_ = new gt_autorizante_cotizadores_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Autorizante Cotizadores';
    ...
    {
        $columns["gt_autorizante_cotizadores_id"]["titulo"] = "Id";
        $columns["gt_autorizante_descripcion"]["titulo"] = "Autorizante";
        $columns["gt_cotizador_descripcion"]["titulo"] = "Cotizador";

        $filtro = array("gt_autorizante_cotizadores.id","gt_autorizante.descripcion",
            "gt_cotizador.descripcion");
