...
class controlador_gt_tipo_proveedor extends _ctl_parent_sin_codigo {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_tipo_proveedor(link: $link);
        $html_ = new gt_tipo_proveedor_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Tipo Proveedor';
        $this->titulo_lista = 'Registro de Tipo Proveedor';
    ...
    {
        $columns["gt_tipo_proveedor_id"]["titulo"] = "Id";
        $columns["gt_tipo_proveedor_descripcion"]["titulo"] = "Descripción";

        $filtro = array("gt_tipo_proveedor.id","gt_tipo_proveedor.descripcion");
