...
class controlador_gt_autorizantes_requisicion extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_autorizantes_requisicion(link: $link);
        $html_ = new gt_autorizantes_requisicion_html(html: $html);
    ...
    {
        $columns["gt_autorizantes_requisicion_id"]["titulo"] = "Id";
        ...
        $filtro = array("gt_autorizantes_requisicion.id","gt_autorizante.descripcion","em_empleado.nombre","em_empleado.ap",
            "em_empleado.am", "gt_requisicion.descripcion", "gt_centro_costo.descripcion");
