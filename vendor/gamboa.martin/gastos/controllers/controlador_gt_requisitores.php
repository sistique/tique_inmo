...
class controlador_gt_requisitores extends _ctl_base {
    ...
    {
        $this->seccion_titulo = 'Requisitores';
    ...
    {
        $columns["gt_requisitores_id"]["titulo"] = "Id";
        $columns["em_empleado_nombre"]["titulo"] = "Requisitor";
        ...
        $filtro = array("gt_requisitores.id","gt_requisitor.descripcion","em_empleado.nombre","em_empleado.ap",
