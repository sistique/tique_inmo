...
use html\gt_requisicion_etapa_html;
use html\gt_solicitud_producto_html;
use PDO;
use stdClass;

class controlador_gt_requisicion_etapa extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_requisicion_etapa(link: $link);
        $html_ = new gt_requisicion_etapa_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Requisicion Etapa';
        $this->titulo_lista = 'Registro de Requisicion Etapa';
    ...
    {
        $columns["gt_requisicion_etapa_id"]["titulo"] = "Id";
        ...
        $columns["gt_requisicion_etapa_fecha"]["titulo"] = "Etapa";

        $filtro = array("gt_requisicion_etapa.id","gt_requisicion.descripcion","pr_proceso.descripcion",
            "pr_etapa.descripcion", "gt_requisicion_etapa.fecha");
