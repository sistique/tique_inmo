...
class controlador_gt_solicitantes extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_solicitantes(link: $link);
        $html_ = new gt_solicitantes_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Solicitantes';
        $this->titulo_lista = 'Registro de Solicitantes';
