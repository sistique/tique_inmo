...
class controlador_gt_solicitante extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_solicitante(link: $link);
        $html_ = new gt_solicitante_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Solicitante';
        $this->titulo_lista = 'Registro de Solicitante';
    ...
    {
        $columns["gt_solicitante_id"]["titulo"] = "Id";
        $columns["em_empleado_nombre"]["titulo"] = "Empleado";
        $columns["em_empleado_nombre"]["campos"] = array("em_empleado_ap","em_empleado_am");

        $filtro = array("gt_solicitante.id","em_empleado.nombre","em_empleado.ap","em_empleado.am");
