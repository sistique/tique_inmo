...
class controlador_gt_requisicion_producto extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_requisicion_producto(link: $link);
        $html_ = new gt_requisicion_producto_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Requisicion Producto';
        $this->titulo_lista = 'Registro de Requisicion Producto';
    ...
    protected function init_datatable(): stdClass
    {
        ...
        $filtro = array("gt_requisicion_producto.id","gt_requisicion.descripcion","com_producto.descripcion",
            "cat_sat_unidad.descripcion", "gt_requisicion_producto.cantidad");
