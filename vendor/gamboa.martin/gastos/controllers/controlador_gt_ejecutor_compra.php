...
class controlador_gt_ejecutor_compra extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_ejecutor_compra(link: $link);
        $html_ = new gt_ejecutor_compra_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Ejecutor Compra';
        $this->titulo_lista = 'Registro de Ejecutores de Compra';
    ...
    {
        $columns["gt_ejecutor_compra_id"]["titulo"] = "Id";
        $columns["em_empleado_nombre"]["titulo"] = "Empleado";
        $columns["em_empleado_nombre"]["campos"] = array("em_empleado_ap","em_empleado_am");

        $filtro = array("gt_ejecutor_compra.id","em_empleado.nombre","em_empleado.ap","em_empleado.am");
