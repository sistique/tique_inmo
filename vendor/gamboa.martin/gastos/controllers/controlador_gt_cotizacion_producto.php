...
use html\gt_cotizacion_producto_html;
...
class controlador_gt_cotizacion_producto extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_cotizacion_producto(link: $link);
        $html_ = new gt_cotizacion_producto_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Cotización Producto';
        $this->titulo_lista = 'Registro de Cotización Producto';
    ...
    protected function init_datatable(): stdClass
    {
        ...
        $filtro = array("gt_cotizacion_producto.id","gt_cotizacion.descripcion","com_producto.descripcion",
            "cat_sat_unidad.descripcion", "gt_cotizacion_producto.cantidad");
