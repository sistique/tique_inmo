...
use gamboamartin\gastos\models\gt_cotizador;
use gamboamartin\gastos\models\gt_requisitor;
...
use html\gt_cotizador_html;
use html\gt_requisitor_html;
use html\gt_solicitante_html;
use PDO;
use stdClass;

class controlador_gt_cotizador extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_cotizador(link: $link);
        $html_ = new gt_cotizador_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Cotizador';
        $this->titulo_lista = 'Registro de Cotizador';
