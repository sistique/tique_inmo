...
class controlador_gt_empleado_usuario extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_empleado_usuario(link: $link);
        $html_ = new gt_empleado_usuario_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Empleado - Usuario';
        $this->titulo_lista = 'Registro de Empleado - Usuario';
    ...
    public function init_selects_inputs(): array
    {
        ...
        return $this->init_selects(keys_selects: $keys_selects, key: "adm_usuario_id", label: "Usuario", cols: 12,
            columns_ds: array("adm_usuario_nombre"));
    }
