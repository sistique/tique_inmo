...
use html\gt_autorizante_ejecutores_compra_html;
...
class controlador_gt_autorizante_ejecutores_compra extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_autorizante_ejecutores_compra(link: $link);
        $html_ = new gt_autorizante_ejecutores_compra_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Autorizante Ejecutores';
        $this->titulo_lista = 'Registro de Ejecutores';
    ...
    {
        $columns["gt_autorizante_ejecutores_compra_id"]["titulo"] = "Id";
        $columns["gt_autorizante_descripcion"]["titulo"] = "Autorizante";
        $columns["gt_ejecutor_compra_descripcion"]["titulo"] = "Ejecutor";

        $filtro = array("gt_autorizante_ejecutores_compra.id","gt_autorizante.descripcion",
            "gt_ejecutor_compra.descripcion");
    ...
    public function init_selects_inputs(): array
    {
        ...
        return $this->init_selects(keys_selects: $keys_selects, key: "gt_ejecutor_compra_id", label: "Ejecutor", cols: 12);
    }
    ...
    public function modifica(bool $header, bool $ws = false): array|stdClass
    {
        ...
        $keys_selects['gt_ejecutor_compra_id']->id_selected = $this->registro['gt_ejecutor_compra_id'];
