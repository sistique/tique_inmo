...
use html\gt_cotizacion_requisicion_html;
use html\gt_empleado_usuario_html;
use PDO;
use stdClass;

class controlador_gt_cotizacion_requisicion extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new gt_cotizacion_requisicion(link: $link);
        $html_ = new gt_cotizacion_requisicion_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Cotización - Requisición';
        $this->titulo_lista = 'Registro de Cotización - Requisición';
    ...
    {
        $columns["gt_cotizacion_requisicion_id"]["titulo"] = "Id";
        $columns["gt_cotizacion_descripcion"]["titulo"] = "Cotización";
        $columns["gt_requisicion_descripcion"]["titulo"] = "Requisición";

        $filtro = array("gt_cotizacion_requisicion.id","gt_cotizacion.descripcion","gt_requisicion.descripcion");
    ...
    public function init_selects_inputs(): array
    {
        ...
        return $this->init_selects(keys_selects: $keys_selects, key: "gt_requisicion_id", label: "Requisición", cols: 12);
    }
