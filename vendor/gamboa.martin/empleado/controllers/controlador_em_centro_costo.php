...
use gamboamartin\empleado\models\em_centro_costo;
use gamboamartin\errores\errores;
use gamboamartin\system\_ctl_base;
use gamboamartin\system\links_menu;
use gamboamartin\template\html;
use html\cat_sat_division_producto_html;
use html\em_centro_costo_html;
use PDO;
use stdClass;

class controlador_em_centro_costo extends _ctl_base
{
    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new em_centro_costo(link: $link);
        $html_ = new em_centro_costo_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Centro de Costos';
        $this->titulo_lista = 'Registro de Costos';
