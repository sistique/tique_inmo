...
class controlador_em_clase_riesgo extends _ctl_base {
    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
        ...
        $html_ = new em_clase_riesgo_html(html: $html);
        ...
        $datatables->columns['em_clase_riesgo_codigo']['titulo'] = 'Cod';
        $datatables->columns['em_clase_riesgo_descripcion']['titulo'] = 'Clase Riesgo';

        $datatables->filtro = array();
        $datatables->filtro[] = 'em_clase_riesgo.id';
        $datatables->filtro[] = 'em_clase_riesgo.codigo';
        $datatables->filtro[] = 'em_clase_riesgo_descripcion';
