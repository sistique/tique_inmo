...
class controlador_em_tipo_descuento extends _ctl_base
{
    ...
    protected function campos_view(): array
    {
        ...
        $init_data = array();
        $init_data['em_metodo_calculo'] = "gamboamartin\\empleado";
    ...
    {
        $this->seccion_titulo = 'Tipo Descuento';
        $this->titulo_lista = 'Registro de Tipos de Descuentos';
    ...
    private function init_datatable(): stdClass
    {
        ...
        $filtro = array("em_tipo_descuento.id", "em_metodo_calculo.descripcion", "em_tipo_descuento.monto");
    ...
    {
        return $this->init_selects(keys_selects: array(), key: "em_metodo_calculo_id", label: "Método Cálculo");
    }
    ...
    public function modifica(bool $header, bool $ws = false): array|stdClass
    {
        ...
        $keys_selects['em_metodo_calculo_id']->id_selected = $this->registro['em_metodo_calculo_id'];
