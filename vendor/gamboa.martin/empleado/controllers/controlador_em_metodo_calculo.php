...
class controlador_em_metodo_calculo extends _ctl_base
{
    ...
    {
        $this->seccion_titulo = 'Método Cálculo';
        $this->titulo_lista = 'Registro de Métodos de Cálculos';
    ...
    private function init_datatable(): stdClass
    {
        ...
        $columns["em_metodo_calculo_descripcion"]["titulo"] = "Método Cálculo";

        $filtro = array("em_tipo_descuento.id", "em_metodo_calculo.descripcion");
