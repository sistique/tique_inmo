...
class controlador_com_direccion_cliente extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new com_direccion_cliente(link: $link);
        $html_ = new com_direccion_cliente_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Dirección de Clientes';
        $this->titulo_lista = 'Registro de Dirección de Clientes';
    ...
    {
        $columns["com_direccion_cliente_id"]["titulo"] = "Id";
        $columns["com_direccion_descripcion"]["titulo"] = "Dirección";
        $columns["com_cliente_descripcion"]["titulo"] = "Cliente";

        $filtro = array("com_direccion_cliente.id","com_direccion.descripcion","com_cliente.descripcion");
    ...
    {
        $keys_selects = $this->init_selects(keys_selects: array(), key: "com_direccion_id", label: "Dirección", cols: 12);
        return $this->init_selects(keys_selects: $keys_selects, key: "com_cliente_id", label: "Cliente", cols: 12);
    }
    ...
    public function modifica(bool $header, bool $ws = false): array|stdClass
    {
        ...
        $keys_selects['com_direccion_id']->id_selected = $this->registro['com_direccion_id'];
