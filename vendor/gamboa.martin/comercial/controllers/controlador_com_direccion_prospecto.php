...
class controlador_com_direccion_prospecto extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new com_direccion_prospecto(link: $link);
        $html_ = new com_direccion_prospecto_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Dirección de Prospecto';
        $this->titulo_lista = 'Registro de Dirección de Prospecto';
    ...
    public function init_selects_inputs(): array
    {
        ...
        return $this->init_selects(keys_selects: $keys_selects, key: "com_prospecto_id", label: "Prospecto", cols: 12);
    }
