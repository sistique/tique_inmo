...
class controlador_cat_sat_uso_cfdi extends _cat_sat_base {
    ...
    private function init_datatable(): stdClass
    {
        ...
        $columns["cat_sat_uso_cfdi_codigo"]["titulo"] = "Código";
        $columns["cat_sat_uso_cfdi_descripcion"]["titulo"] = "Uso CFDI";

        $filtro = array("cat_sat_uso_cfdi.id","cat_sat_uso_cfdi.codigo","cat_sat_uso_cfdi.descripcion");
    ...
    protected function key_selects_txt(array $keys_selects): array
    {
        ...
        $keys_selects = (new \base\controller\init())->key_select_txt(cols: 8, key: 'descripcion',
            keys_selects: $keys_selects, place_holder: 'Uso CFDI');
        if (errores::$error) {
            return $this->errores->error(mensaje: 'Error al maquetar key_selects', data: $keys_selects);
        }
