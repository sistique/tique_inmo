...
class controlador_cat_sat_factor extends _cat_sat_base {
    ...
    {
        $keys = new stdClass();
        $keys->inputs = array('codigo', 'factor');
        $keys->selects = array();
    ...
    protected function key_selects_txt(array $keys_selects): array
    {
        ...
        $keys_selects = (new \base\controller\init())->key_select_txt(cols: 8, key: 'factor',
            keys_selects: $keys_selects, place_holder: 'Factor');
        if (errores::$error) {
            return $this->errores->error(mensaje: 'Error al maquetar key_selects', data: $keys_selects);
        }
