<?php /** @var \gamboamartin\cat_sat\controllers\controlador_cat_sat_division_producto $controlador  controlador en ejecucion */ ?>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="widget  widget-box box-container form-main widget-form-cart" id="form">
                    <form method="post" action="<?php echo $controlador->link_cat_sat_grupo_producto_alta_bd; ?>" class="form-additional">
