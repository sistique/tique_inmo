...
class pr_proceso_html extends html_controler {
    ...
    private function genera_inputs_modifica(controlador_pr_proceso $controler,PDO $link,
    ...
    public function inputs_pr_proceso(controlador_pr_proceso $controlador,
                                    stdClass $params = new stdClass()): array|stdClass
    {
    ...
    public function select_pr_proceso_id(int $cols, bool $con_registros, int $id_selected, PDO $link): array|string
    {
        $modelo = new pr_proceso(link: $link);

        $select = $this->select_catalogo(cols:$cols,con_registros:$con_registros,id_selected:$id_selected,
            modelo: $modelo,label: 'Proceso',required: true);
        if(errores::$error){
