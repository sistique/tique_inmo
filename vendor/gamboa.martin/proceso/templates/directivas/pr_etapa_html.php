...
class pr_etapa_html extends html_controler {

    private function asigna_inputs(controlador_pr_etapa $controler, stdClass $inputs): array|stdClass
    {
    ...
    private function genera_inputs_modifica(controlador_pr_etapa $controler,PDO $link,
    ...
    public function inputs_pr_etapa(controlador_pr_etapa $controlador,
                                           stdClass $params = new stdClass()): array|stdClass
    {
