...
class controlador_pr_entidad extends system {

    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass()){
        $modelo = new pr_entidad(link: $link);
        $html_ = new pr_entidad_html(html: $html);
        $obj_link = new links_menu(link: $link, registro_id: $this->registro_id);
        parent::__construct(html:$html_, link: $link,modelo:  $modelo, obj_link: $obj_link, paths_conf: $paths_conf);

        $this->titulo_lista = 'Entidad';
    }
    ...
    public function alta(bool $header, bool $ws = false): array|string
    {
        ...
        $inputs = (new pr_entidad_html(html: $this->html_base))->genera_inputs_alta(controler: $this, link: $this->link);
        if(errores::$error){
    ...
    private function base(stdClass $params = new stdClass()): array|stdClass
    {
        ...
        $inputs = (new pr_entidad_html(html: $this->html_base))->inputs_pr_entidad(
