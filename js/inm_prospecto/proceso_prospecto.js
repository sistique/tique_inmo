...
function cambiarPestannaGeneral(pestannas,pestanna,pentannascontenido) {
    ...
    $(document).ready(function(){
        ...
        if(liActivo !== null){
            ...
            if(pentannascontenido.id === 'pestanasprospecto'){
                pestana_actual = 'pestanaprospecto1';
                cambiarPestanna_inicialprospecto(pentannascontenido);
            }
        }
    });
}
...
function cambiarPestanna_inicialprospecto(pestannas) {
    let pestanna_ini = 'pestanaprospecto1';
    if(pestana_actual !== ''){
...
function valor_inicial() {
    ...
    $.ajax({
        type: "POST",
        data: {id: registro_id},
        url: 'index.php?seccion=inm_prospecto&accion=get_etapa_actual&ws=1&session_id=' + session_id,
...
$(".elimina_img").on("click", function() {
    let inm_doc_prospecto_id = $(this).data('inm_doc_prospecto_id');
    ...
    $.ajax({
        ...
        success: function(data_r) {
            $.ajax({
                type: "POST",
                data: {id:inm_doc_prospecto_id},
                url: 'index.php?seccion=inm_doc_prospecto&accion=elimina_bd&ws=1&registro_id='+inm_doc_prospecto_id+'&session_id='+session_id,
                success: function(data_r) {
                    console.log(data_r);
                },
